...
export default function Connect() {
  const [selected, setSelected] = useState("General Inquiries");
  ...
  return (
    <section id="contact" className="px-4 py-10 flex flex-col items-center justify-center">
      ...
      {/* Flex container for form + info */}
      <div className="flex flex-col md:flex-row flex-wrap justify-center items-center gap-x-8 gap-y-8 w-full max-w-6xl">
        
        {/* Contact Form */}
        <form className="bg-white/10 backdrop-blur-xl rounded-xl border border-white/30 p-8 sm:p-10 flex flex-col gap-6 w-full max-w-xl shadow-lg transition-transform duration-300 hover:scale-[1.02]">
          <div className="flex flex-col sm:flex-row gap-4 relative">
            <input
              className="flex-1 px-4 py-3 rounded-xl bg-transparent border border-white/30 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#00ffea] transition"
              placeholder="Your Name"
            />
            <div className="flex-1 relative">
              <input
                className="w-full pl-10 pr-4 py-3 rounded-xl bg-transparent border border-white/30 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#00ffea] transition"
          ...
          <div className="relative w-full">
            <Listbox value={selected} onChange={setSelected}>
              <Listbox.Button className="w-full px-4 py-3 rounded-2xl bg-white/20 border border-white/30 shadow-lg text-white focus:outline-none focus:ring-2 focus:ring-[#00ffea] cursor-pointer flex justify-between items-center">
                {selected}
          ...
          <textarea
            rows="3"
            className="px-4 py-3 rounded-xl bg-transparent border border-white/30 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#00ffea] transition"
            placeholder="Your Message"
          ></textarea>

          <button
            type="submit"
            className="bg-white/20 text-white py-3 rounded-xl flex items-center justify-center gap-2 font-semibold tracking-wide hover:bg-white/30 transition-transform duration-200 hover:scale-105"
          >
            <svg
              width="22"
              height="22"
        ...
        <div className="flex flex-col gap-8 w-full max-w-xl flex-1">
          {/* Opportunities */}
          <div className="flex items-center gap-5 bg-purple-900/60 rounded-xl px-6 sm:px-12 py-6 sm:py-8 shadow-lg w-full transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
